...
public class TypeServiceImplTest {
    ...
    void init() {
        ...
        parent.setAssocsToOthers(new HashSet<>(Arrays.asList(parentAssocEntity, parentAssocEntity2)));
        ...
        typeEntity.setAssocsToOthers(Collections.singleton(childAssocEntity));
    ...
    void testGetAll() {
        ...
        assertEquals(resultTypeDto.getParent(), RecordRef.create("emodel", "type", "parent"));
